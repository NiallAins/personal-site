//
// Compliles all SCSS variables in _var.scss and then converts to Typescript variables
// includes auto-renaming, unit conversion, and type inference:
//   w-page: 80rem -> WIDTH_PAGE: number = 1280
//
...
FS.readFile(
    ...
    (_, data) => {
        ...
        FS.writeFile(
            PATH_TO_TS,
                `/* Generated by "build-scripts/scss-to-js.js" from "${ PATH_FROM }" */\n\n` +
                'export const\n' +
                JS_VARS
