...
export const
    ...
    COLOR_HSL_TERRAIN_LAND_2: [number, number, number, number] = [62, 82, 35, 1],
    COLOR_TERRAINLAND_2: string = 'hsl(62, 82%, 35%)',
    COLOR_HSL_TERRAIN_LAND_3: [number, number, number, number] = [106, 80, 15, 1],
    COLOR_TERRAIN_LAND_3: string = 'hsl(106, 80%, 15%)',
